...
import com.artfii.amq.disruptor.BatchEventProcessor;
import com.artfii.amq.disruptor.EventFactory;
import com.artfii.amq.disruptor.EventHandler;
import com.artfii.amq.disruptor.EventProcessor;
import com.artfii.amq.disruptor.EventTranslator;
import com.artfii.amq.disruptor.EventTranslatorOneArg;
import com.artfii.amq.disruptor.EventTranslatorThreeArg;
import com.artfii.amq.disruptor.EventTranslatorTwoArg;
...
import com.artfii.amq.disruptor.TimeoutException;
import com.artfii.amq.disruptor.WaitStrategy;
import com.artfii.amq.disruptor.WorkHandler;
import com.artfii.amq.disruptor.WorkerPool;
import com.artfii.amq.disruptor.util.Util;
...
public class Disruptor<T>
{
    ...
    /**
     * Create a new Disruptor. Will default to {@link com.artfii.amq.disruptor.BlockingWaitStrategy} and
     ...
     *
     * @param handlers the event handlers, previously set up with {@link #handleEventsWith(com.artfii.amq.disruptor.EventHandler[])},
     ...
     *
     * @param processors the event processors, previously set up with {@link #handleEventsWith(com.artfii.amq.disruptor.EventProcessor...)},
     *                   that will form the barrier for subsequent handlers or processors.
     * @return an {@link EventHandlerGroup} that can be used to setup a {@link SequenceBarrier} over the specified event processors.
     * @see #after(com.artfii.amq.disruptor.EventHandler[])
     */
     ...
     *
     * @param eventTranslator the translator that will load write into the event.
     */
    ...
    /**
     * Calls {@link com.artfii.amq.disruptor.EventProcessor#halt()} on all of the event processors created via this disruptor.
     */
    public void halt()
    {
        for (final ConsumerInfo consumerInfo : consumerRepository)
    ...
    /**
     * The capacity of the write structure to hold entries.
     *
     * @return the size of the RingBuffer.
     * @see com.artfii.amq.disruptor.Sequencer#getBufferSize()
     */
