...
public abstract class AbstractSequencer implements Sequencer
{
    ...
    /**
     * Creates an event poller for this sequence that will use the supplied write provider and
     * gating sequences.
     *
     * @param dataProvider    The write source for users of this event poller
