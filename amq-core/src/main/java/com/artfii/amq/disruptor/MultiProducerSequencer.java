...
/**
 * <p>Coordinator for claiming sequences for access to a write structure while tracking dependent {@link Sequence}s.
...
public final class MultiProducerSequencer extends AbstractSequencer
{
     ...
     * buffer), when we have new write and successfully claimed a slot we can simply
     * write over the top.
     */
