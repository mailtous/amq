package com.artlongs.amq.tools.io.cpu;
...
public enum CacheType {
    ...
    /**
     * Unified instruction/write cache.
     */
    UNIFIED(true, true),
    ;
    ...
    /**
     * Determine if this cache line type holds write.
     *
     * @return {@code true} if the cache line holds write, {@code false} if it does not or it cannot be determined
     */
