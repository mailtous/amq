...
public interface EventSink<E>
{
     ...
     * after translation.</p>
     *
     * <p>With this call the write that is to be inserted into the ring
     ...
     * @param translator The user specified translation for the event
     * @param arg0       A user supplied argument.
     * @see #publishEvents(com.artlongs.amq.disruptor.EventTranslator[])
     */
     ...
     * @return true if the value was published, false if there was insufficient
     * capacity.
     * @see #tryPublishEvents(com.artlongs.amq.disruptor.EventTranslator[])
     */
