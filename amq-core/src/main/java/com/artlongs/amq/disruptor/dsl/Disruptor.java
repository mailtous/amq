...
import com.artlongs.amq.disruptor.EventProcessor;
import com.artlongs.amq.disruptor.EventTranslator;
import com.artlongs.amq.disruptor.EventTranslatorOneArg;
import com.artlongs.amq.disruptor.EventTranslatorThreeArg;
import com.artlongs.amq.disruptor.EventTranslatorTwoArg;
...
import com.artlongs.amq.disruptor.TimeoutException;
import com.artlongs.amq.disruptor.WaitStrategy;
import com.artlongs.amq.disruptor.WorkHandler;
import com.artlongs.amq.disruptor.WorkerPool;
...
public class Disruptor<T>
{
    ...
    /**
     * Create a new Disruptor. Will default to {@link com.artlongs.amq.disruptor.BlockingWaitStrategy} and
     ...
     *
     * @param handlers the event handlers, previously set up with {@link #handleEventsWith(com.artlongs.amq.disruptor.EventHandler[])},
     ...
     *
     * @param processors the event processors, previously set up with {@link #handleEventsWith(com.artlongs.amq.disruptor.EventProcessor...)},
     *                   that will form the barrier for subsequent handlers or processors.
     * @return an {@link EventHandlerGroup} that can be used to setup a {@link SequenceBarrier} over the specified event processors.
     * @see #after(com.artlongs.amq.disruptor.EventHandler[])
     */
    ...
    /**
     * Calls {@link com.artlongs.amq.disruptor.EventProcessor#halt()} on all of the event processors created via this disruptor.
     */
    public void halt()
    {
        for (final ConsumerInfo consumerInfo : consumerRepository)
     ...
     * @see com.artlongs.amq.disruptor.Sequencer#getBufferSize()
     */
